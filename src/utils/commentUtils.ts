...
export function commentUtils() {
    ...
    async function addComment(inputRef: any, id: string) {
        ...
        try {
            ...
            setCommentList((prev) => [...prev, { comment: comment, username: user?.displayName, img: img, }] as Comment[])
    ...
    return { handleComment, comment, setComment, commentLoading, addComment, commentList, volatileList, setCommentList,deleteComment }
}
