    ...
    return (
        ...
        <div>
            <div className="flex gap-2 items-center mb-2 justify-between content">
                ...
                <div>
                    <svg onClick={() => { setShowOptions(true),isUserComment(commentId) }} aria-label="More options" className=" opacity-0 content-more " fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
